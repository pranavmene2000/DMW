...
function App() {
  ...
  return (
    <Container>
      <Typography data-testid="titleText" align="center" color="textSecondary" variant="h4">
      ...
      {loading ? (
        <Loader data-testid="isLoader" />
      ) : <TweetsContainer data-testid="tweetsContainer" data={data} />}
